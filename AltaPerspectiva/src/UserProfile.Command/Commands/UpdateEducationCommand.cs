...
namespace UserProfile.Command.Commands
{
    ...
    {
        public UpdateEducationCommand(Guid userId,String institute,DateTime timeFrameFrom,DateTime timeFrameTo,Boolean completedStudies,String description, String especiality)
        {
            UserId = userId;
            Institute = institute;
