...
namespace UserProfile.Command.Commands
{
    public class UpdateEducationCommand : ICommand
    {
        ...
        public UpdateEducationCommand(Guid credentialId, String schoolName, String schoolDegreeName, DateTime? schoolCompletionDate, String collegeName, String collegeDegree, DateTime? collegeCompletionDate, String certification, String certificationType)
        {
