...
var FollowingComponent = (function () {
    function FollowingComponent(_route, profileServ) {
        this._route = _route;
    ...
    FollowingComponent.prototype.ngOnInit = function () {
        ...
        this.sub = this._route.parent.params.subscribe(function (params) {
            _this.profileServ.GetFollowingsByUserId(params['userId']).subscribe(function (usr) {
                _this.user = usr;
                console.log(_this.user);
            });
        });
    };
    FollowingComponent.prototype.ngOnDestroy = function () {
