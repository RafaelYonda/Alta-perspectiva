...
export class View_PreviewImageComponent0 extends import1.AppView<import0.PreviewImageComponent> {
  ...
  createInternal(rootSelector:string):import9.ComponentRef<any> {
    ...
    this._el_1 = import3.createRenderElement(this.renderer,parentRenderNode,'div',new import3.InlineArray4(4,'class','modal-overlay z-modal modal-image','id','dialogModal'),(null as any));
