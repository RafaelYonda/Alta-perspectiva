...
import * as import0 from './linkedin.component';
...
var Wrapper_LinkedinComponent = (function () {
    function Wrapper_LinkedinComponent(p0, p1, p2) {
        this._changed = false;
        this.context = new import0.LinkedinComponent(p0, p1, p2);
    }
    Wrapper_LinkedinComponent.prototype.ngOnDetach = function (view, componentView, el) {
    };
    Wrapper_LinkedinComponent.prototype.ngOnDestroy = function () {
    };
    Wrapper_LinkedinComponent.prototype.ngDoCheck = function (view, el, throwOnChange) {
        var changed = this._changed;
        this._changed = false;
        return changed;
    };
    Wrapper_LinkedinComponent.prototype.checkHost = function (view, componentView, el, throwOnChange) {
    };
    Wrapper_LinkedinComponent.prototype.handleEvent = function (eventName, $event) {
        var result = true;
        return result;
    };
    Wrapper_LinkedinComponent.prototype.subscribe = function (view, _eventHandler) {
        this._eventHandler = _eventHandler;
    };
    return Wrapper_LinkedinComponent;
}());
export { Wrapper_LinkedinComponent };
var renderType_LinkedinComponent_Host = import3.createRenderComponentType('', 0, import4.ViewEncapsulation.None, [], {});
var View_LinkedinComponent_Host0 = (function (_super) {
    __extends(View_LinkedinComponent_Host0, _super);
    function View_LinkedinComponent_Host0(viewUtils, parentView, parentIndex, parentElement) {
        return _super.call(this, View_LinkedinComponent_Host0, renderType_LinkedinComponent_Host, import7.ViewType.HOST, viewUtils, parentView, parentIndex, parentElement, import8.ChangeDetectorStatus.CheckAlways) || this;
    }
    View_LinkedinComponent_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer, 'linkedin', import3.EMPTY_INLINE_ARRAY, rootSelector, null);
        this._vc_0 = new import5.ViewContainer(0, null, this, this._el_0);
        this.compView_0 = new View_LinkedinComponent0(this.viewUtils, this, 0, this._el_0);
        this._ProfileService_0_5 = new import6.ProfileService(this.injectorGet(import10.Http, this.parentIndex));
        this._LinkedinComponent_0_6 = new Wrapper_LinkedinComponent(this._ProfileService_0_5, this.injectorGet(import11.ToastsManager, this.parentIndex), this._vc_0.vcRef);
        this.compView_0.create(this._LinkedinComponent_0_6.context);
        ...
        return new import9.ComponentRef_(0, this, this._el_0, this._LinkedinComponent_0_6.context);
    };
    View_LinkedinComponent_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import6.ProfileService) && (0 === requestNodeIndex))) {
            return this._ProfileService_0_5;
        }
        if (((token === import0.LinkedinComponent) && (0 === requestNodeIndex))) {
            return this._LinkedinComponent_0_6.context;
        }
        return notFoundResult;
    };
    View_LinkedinComponent_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        this._LinkedinComponent_0_6.ngDoCheck(this, this._el_0, throwOnChange);
        this._vc_0.detectChangesInNestedViews(throwOnChange);
        this.compView_0.internalDetectChanges(throwOnChange);
    };
    View_LinkedinComponent_Host0.prototype.destroyInternal = function () {
        this._vc_0.destroyNestedViews();
        this.compView_0.destroy();
    };
    View_LinkedinComponent_Host0.prototype.visitRootNodesInternal = function (cb, ctx) {
        cb(this._vc_0.nativeElement, ctx);
        this._vc_0.visitNestedViewRootNodes(cb, ctx);
        cb(this._el_1, ctx);
    };
    return View_LinkedinComponent_Host0;
}(import1.AppView));
export var LinkedinComponentNgFactory = new import9.ComponentFactory('linkedin', View_LinkedinComponent_Host0, import0.LinkedinComponent);
var styles_LinkedinComponent = ['.credential-dialog[_ngcontent-%COMP%] {\n        margin: 15% auto;\n        max-width: 45%;\n    }\n\n    .profile-modal-body[_ngcontent-%COMP%] {\n        position: relative;\n        padding: 15px;\n        background-color: #f6f6f6;\n        margin: 0px;\n        border-bottom-left-radius: 5px;\n        border-bottom-right-radius: 5px;\n    }\n\n        .profile-modal-body[_ngcontent-%COMP%]   input[_ngcontent-%COMP%] {\n            width: 100%;\n            border: 1px solid #bdbdbd;\n            border-radius: 3px;\n            padding: 2px 5px;\n            margin-top: 5px;\n            margin-bottom: 5px;\n        }\n\n        .profile-modal-body[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover {\n            text-decoration: underline;\n        }\n\n    .profile-modal-button-container[_ngcontent-%COMP%] {\n        text-align: right;\n    }\n\n        .profile-modal-button-container[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n            margin-right: 10px;\n        }\n\n    .modal-header[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%] {\n        font-weight: bold;\n    }'];
var renderType_LinkedinComponent = import3.createRenderComponentType('', 0, import4.ViewEncapsulation.Emulated, styles_LinkedinComponent, {});
var View_LinkedinComponent0 = (function (_super) {
    __extends(View_LinkedinComponent0, _super);
    function View_LinkedinComponent0(viewUtils, parentView, parentIndex, parentElement) {
        return _super.call(this, View_LinkedinComponent0, renderType_LinkedinComponent, import7.ViewType.COMPONENT, viewUtils, parentView, parentIndex, parentElement, import8.ChangeDetectorStatus.CheckAlways) || this;
    }
    View_LinkedinComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_13 = this.renderer.createText(this._el_12, 'Guardar cuenta de Linkedin', null);
        ...
        this._DefaultValueAccessor_24_3 = new import12.Wrapper_DefaultValueAccessor(this.renderer, new import15.ElementRef(this._el_24));
        this._NG_VALUE_ACCESSOR_24_4 = [this._DefaultValueAccessor_24_3.context];
        this._NgModel_24_5 = new import13.Wrapper_NgModel(null, null, null, this._NG_VALUE_ACCESSOR_24_4);
    ...
    View_LinkedinComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import16.DefaultValueAccessor) && (24 === requestNodeIndex))) {
            return this._DefaultValueAccessor_24_3.context;
        }
        if (((token === import17.NG_VALUE_ACCESSOR) && (24 === requestNodeIndex))) {
            return this._NG_VALUE_ACCESSOR_24_4;
        }
        if (((token === import18.NgModel) && (24 === requestNodeIndex))) {
            return this._NgModel_24_5.context;
        }
        if (((token === import19.NgControl) && (24 === requestNodeIndex))) {
            return this._NgControl_24_6;
        }
        if (((token === import20.NgControlStatus) && (24 === requestNodeIndex))) {
            return this._NgControlStatus_24_7.context;
        }
        return notFoundResult;
    };
    View_LinkedinComponent0.prototype.detectChangesInternal = function (throwOnChange) {
    ...
    View_LinkedinComponent0.prototype.destroyInternal = function () {
        this._NgModel_24_5.ngOnDestroy();
    };
    View_LinkedinComponent0.prototype.handleEvent_1 = function (eventName, $event) {
    ...
    View_LinkedinComponent0.prototype.handleEvent_5 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        if ((eventName == 'click')) {
    ...
    View_LinkedinComponent0.prototype.handleEvent_24 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
    ...
    View_LinkedinComponent0.prototype.handleEvent_29 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        if ((eventName == 'click')) {
    ...
    View_LinkedinComponent0.prototype.handleEvent_32 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        if ((eventName == 'click')) {
            var pd_sub_0 = (this.context.onClickedExit() !== false);
    ...
    View_LinkedinComponent0.prototype.handleEvent_35 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        if ((eventName == 'click')) {
    ...
    return View_LinkedinComponent0;
}(import1.AppView));
export { View_LinkedinComponent0 };
