...
import * as import0 from './facebook.component';
...
var Wrapper_FacebookComponent = (function () {
    function Wrapper_FacebookComponent(p0, p1, p2) {
        this._changed = false;
        this.context = new import0.FacebookComponent(p0, p1, p2);
    }
    Wrapper_FacebookComponent.prototype.ngOnDetach = function (view, componentView, el) {
    };
    Wrapper_FacebookComponent.prototype.ngOnDestroy = function () {
    };
    Wrapper_FacebookComponent.prototype.ngDoCheck = function (view, el, throwOnChange) {
        var changed = this._changed;
        this._changed = false;
        return changed;
    };
    Wrapper_FacebookComponent.prototype.checkHost = function (view, componentView, el, throwOnChange) {
    };
    Wrapper_FacebookComponent.prototype.handleEvent = function (eventName, $event) {
        var result = true;
        return result;
    };
    Wrapper_FacebookComponent.prototype.subscribe = function (view, _eventHandler) {
        this._eventHandler = _eventHandler;
    };
    return Wrapper_FacebookComponent;
}());
export { Wrapper_FacebookComponent };
var renderType_FacebookComponent_Host = import3.createRenderComponentType('', 0, import4.ViewEncapsulation.None, [], {});
var View_FacebookComponent_Host0 = (function (_super) {
    __extends(View_FacebookComponent_Host0, _super);
    function View_FacebookComponent_Host0(viewUtils, parentView, parentIndex, parentElement) {
        return _super.call(this, View_FacebookComponent_Host0, renderType_FacebookComponent_Host, import7.ViewType.HOST, viewUtils, parentView, parentIndex, parentElement, import8.ChangeDetectorStatus.CheckAlways) || this;
    }
    View_FacebookComponent_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer, 'facebook', import3.EMPTY_INLINE_ARRAY, rootSelector, null);
        this._vc_0 = new import5.ViewContainer(0, null, this, this._el_0);
        this.compView_0 = new View_FacebookComponent0(this.viewUtils, this, 0, this._el_0);
        this._ProfileService_0_5 = new import6.ProfileService(this.injectorGet(import10.Http, this.parentIndex));
        this._FacebookComponent_0_6 = new Wrapper_FacebookComponent(this._ProfileService_0_5, this.injectorGet(import11.ToastsManager, this.parentIndex), this._vc_0.vcRef);
        this.compView_0.create(this._FacebookComponent_0_6.context);
        ...
        return new import9.ComponentRef_(0, this, this._el_0, this._FacebookComponent_0_6.context);
    };
    View_FacebookComponent_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import6.ProfileService) && (0 === requestNodeIndex))) {
            return this._ProfileService_0_5;
        }
        if (((token === import0.FacebookComponent) && (0 === requestNodeIndex))) {
            return this._FacebookComponent_0_6.context;
        }
        return notFoundResult;
    };
    View_FacebookComponent_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        this._FacebookComponent_0_6.ngDoCheck(this, this._el_0, throwOnChange);
        this._vc_0.detectChangesInNestedViews(throwOnChange);
        this.compView_0.internalDetectChanges(throwOnChange);
    };
    View_FacebookComponent_Host0.prototype.destroyInternal = function () {
        this._vc_0.destroyNestedViews();
        this.compView_0.destroy();
    };
    View_FacebookComponent_Host0.prototype.visitRootNodesInternal = function (cb, ctx) {
        cb(this._vc_0.nativeElement, ctx);
        this._vc_0.visitNestedViewRootNodes(cb, ctx);
        cb(this._el_1, ctx);
    };
    return View_FacebookComponent_Host0;
}(import1.AppView));
export var FacebookComponentNgFactory = new import9.ComponentFactory('facebook', View_FacebookComponent_Host0, import0.FacebookComponent);
var styles_FacebookComponent = ['.credential-dialog[_ngcontent-%COMP%] {\n        margin: 15% auto;\n        max-width: 45%;\n    }\n\n    .profile-modal-body[_ngcontent-%COMP%] {\n        position: relative;\n        padding: 15px;\n        background-color: #f6f6f6;\n        margin: 0px;\n        border-bottom-left-radius: 5px;\n        border-bottom-right-radius: 5px;\n    }\n\n        .profile-modal-body[_ngcontent-%COMP%]   input[_ngcontent-%COMP%] {\n            width: 100%;\n            border: 1px solid #bdbdbd;\n            border-radius: 3px;\n            padding: 2px 5px;\n            margin-top: 5px;\n            margin-bottom: 5px;\n        }\n\n        .profile-modal-body[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover {\n            text-decoration: underline;\n        }\n\n    .profile-modal-button-container[_ngcontent-%COMP%] {\n        text-align: right;\n    }\n\n        .profile-modal-button-container[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n            margin-right: 10px;\n        }\n\n    .modal-header[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%] {\n        font-weight: bold;\n    }'];
var renderType_FacebookComponent = import3.createRenderComponentType('', 0, import4.ViewEncapsulation.Emulated, styles_FacebookComponent, {});
var View_FacebookComponent0 = (function (_super) {
    __extends(View_FacebookComponent0, _super);
    function View_FacebookComponent0(viewUtils, parentView, parentIndex, parentElement) {
        return _super.call(this, View_FacebookComponent0, renderType_FacebookComponent, import7.ViewType.COMPONENT, viewUtils, parentView, parentIndex, parentElement, import8.ChangeDetectorStatus.CheckAlways) || this;
    }
    View_FacebookComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_13 = this.renderer.createText(this._el_12, 'Guardar cuenta de Facebook', null);
    ...
    View_FacebookComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    View_FacebookComponent0.prototype.detectChangesInternal = function (throwOnChange) {
    ...
    View_FacebookComponent0.prototype.destroyInternal = function () {
        this._NgModel_24_5.ngOnDestroy();
    };
    View_FacebookComponent0.prototype.handleEvent_1 = function (eventName, $event) {
    ...
    View_FacebookComponent0.prototype.handleEvent_5 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        if ((eventName == 'click')) {
    ...
    View_FacebookComponent0.prototype.handleEvent_24 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
    ...
    View_FacebookComponent0.prototype.handleEvent_29 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        if ((eventName == 'click')) {
    ...
    View_FacebookComponent0.prototype.handleEvent_32 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        if ((eventName == 'click')) {
            var pd_sub_0 = (this.context.onClickedExit() !== false);
    ...
    View_FacebookComponent0.prototype.handleEvent_35 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        if ((eventName == 'click')) {
    ...
    return View_FacebookComponent0;
}(import1.AppView));
export { View_FacebookComponent0 };
