...
import * as import0 from './add-education.component';
...
var Wrapper_AddEducationComponent = (function () {
    function Wrapper_AddEducationComponent(p0) {
        this._changed = false;
        this.context = new import0.AddEducationComponent(p0);
    }
    Wrapper_AddEducationComponent.prototype.ngOnDetach = function (view, componentView, el) {
    };
    Wrapper_AddEducationComponent.prototype.ngOnDestroy = function () {
    };
    Wrapper_AddEducationComponent.prototype.ngDoCheck = function (view, el, throwOnChange) {
        var changed = this._changed;
        this._changed = false;
        return changed;
    };
    Wrapper_AddEducationComponent.prototype.checkHost = function (view, componentView, el, throwOnChange) {
    };
    Wrapper_AddEducationComponent.prototype.handleEvent = function (eventName, $event) {
        var result = true;
        return result;
    };
    Wrapper_AddEducationComponent.prototype.subscribe = function (view, _eventHandler) {
        this._eventHandler = _eventHandler;
    };
    return Wrapper_AddEducationComponent;
}());
export { Wrapper_AddEducationComponent };
var renderType_AddEducationComponent_Host = import3.createRenderComponentType('', 0, import4.ViewEncapsulation.None, [], {});
var View_AddEducationComponent_Host0 = (function (_super) {
    __extends(View_AddEducationComponent_Host0, _super);
    function View_AddEducationComponent_Host0(viewUtils, parentView, parentIndex, parentElement) {
        return _super.call(this, View_AddEducationComponent_Host0, renderType_AddEducationComponent_Host, import6.ViewType.HOST, viewUtils, parentView, parentIndex, parentElement, import7.ChangeDetectorStatus.CheckAlways) || this;
    }
    View_AddEducationComponent_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer, 'add-education', import3.EMPTY_INLINE_ARRAY, rootSelector, null);
        this.compView_0 = new View_AddEducationComponent0(this.viewUtils, this, 0, this._el_0);
        this._ProfileService_0_3 = new import5.ProfileService(this.injectorGet(import9.Http, this.parentIndex));
        this._AddEducationComponent_0_4 = new Wrapper_AddEducationComponent(this._ProfileService_0_3);
        this.compView_0.create(this._AddEducationComponent_0_4.context);
        this.init(this._el_0, (this.renderer.directRenderer ? null : [this._el_0]), null);
        return new import8.ComponentRef_(0, this, this._el_0, this._AddEducationComponent_0_4.context);
    };
    View_AddEducationComponent_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import5.ProfileService) && (0 === requestNodeIndex))) {
            return this._ProfileService_0_3;
        }
        if (((token === import0.AddEducationComponent) && (0 === requestNodeIndex))) {
            return this._AddEducationComponent_0_4.context;
        }
        return notFoundResult;
    };
    View_AddEducationComponent_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        this._AddEducationComponent_0_4.ngDoCheck(this, this._el_0, throwOnChange);
        this.compView_0.internalDetectChanges(throwOnChange);
    };
    View_AddEducationComponent_Host0.prototype.destroyInternal = function () {
        this.compView_0.destroy();
    };
    View_AddEducationComponent_Host0.prototype.visitRootNodesInternal = function (cb, ctx) {
        cb(this._el_0, ctx);
    };
    return View_AddEducationComponent_Host0;
}(import1.AppView));
export var AddEducationComponentNgFactory = new import8.ComponentFactory('add-education', View_AddEducationComponent_Host0, import0.AddEducationComponent);
var styles_AddEducationComponent = ['.credential-dialog[_ngcontent-%COMP%] {\n        margin: 10% auto;\n        max-width: 45%;\n    }\n\n    .profile-modal-body[_ngcontent-%COMP%] {\n        position: relative;\n        padding: 15px;\n        background-color: #f6f6f6;\n        margin: 0px;\n        border-bottom-left-radius: 5px;\n        border-bottom-right-radius: 5px;\n    }\n\n        .profile-modal-body[_ngcontent-%COMP%]   input[_ngcontent-%COMP%] {\n            width: 100%;\n            border: 1px solid #bdbdbd;\n            border-radius: 3px;\n            padding: 2px 5px;\n            margin-top: 5px;\n            margin-bottom: 5px;\n        }\n\n        .profile-modal-body[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover {\n            text-decoration: underline;\n        }\n\n    .profile-modal-button-container[_ngcontent-%COMP%] {\n        text-align: right;\n    }\n\n        .profile-modal-button-container[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n            margin-right: 10px;\n        }\n\n    .modal-header[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%] {\n        font-weight: bold;\n    }\n    .col-sm-8[_ngcontent-%COMP%] {\n        padding-left: 0;\n    }'];
var renderType_AddEducationComponent = import3.createRenderComponentType('', 0, import4.ViewEncapsulation.Emulated, styles_AddEducationComponent, {});
var View_AddEducationComponent0 = (function (_super) {
    __extends(View_AddEducationComponent0, _super);
    function View_AddEducationComponent0(viewUtils, parentView, parentIndex, parentElement) {
        var _this = _super.call(this, View_AddEducationComponent0, renderType_AddEducationComponent, import6.ViewType.COMPONENT, viewUtils, parentView, parentIndex, parentElement, import7.ChangeDetectorStatus.CheckAlways) || this;
    ...
    View_AddEducationComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_13 = this.renderer.createText(this._el_12, 'Información de educación', null);
        ...
        this._text_23 = this.renderer.createText(this._el_22, 'Institución*', null);
        ...
        this._el_27 = import3.createRenderElement(this.renderer, this._el_25, 'input', new import3.InlineArray16(12, 'class', 'form-control', 'id', 'SchoolName', 'name', 'SchoolName', 'placeholder', '¿Dónde estudiaste?', 'required', '', 'type', 'text'), null);
        ...
        this._text_38 = this.renderer.createText(this._el_37, 'Concentración', null);
        ...
        this._el_42 = import3.createRenderElement(this.renderer, this._el_40, 'input', new import3.InlineArray8(8, 'class', 'form-control', 'id', 'SchoolDegreeName', 'placeholder', '¿Qué estudiaste?', 'type', 'text'), null);
        ...
        this._NgModel_42_5 = new import14.Wrapper_NgModel(this._ControlContainer_18_4, null, null, this._NG_VALUE_ACCESSOR_42_4);
        ...
        this._el_46 = import3.createRenderElement(this.renderer, this._el_18, 'div', new import3.InlineArray2(2, 'class', 'profile-modal-button-container'), null);
        ...
        this._text_58 = this.renderer.createText(this._el_16, '\n            ', null);
    ...
    View_AddEducationComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import24.NgForm) && ((18 <= requestNodeIndex) && (requestNodeIndex <= 57)))) {
            return this._NgForm_18_3.context;
        }
        if (((token === import25.ControlContainer) && ((18 <= requestNodeIndex) && (requestNodeIndex <= 57)))) {
            return this._ControlContainer_18_4;
        }
        if (((token === import23.NgControlStatusGroup) && ((18 <= requestNodeIndex) && (requestNodeIndex <= 57)))) {
            return this._NgControlStatusGroup_18_5.context;
        }
        return notFoundResult;
    };
    View_AddEducationComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_27_2_0 = 'SchoolName';
        this._NgModel_27_7.check_name(currVal_27_2_0, throwOnChange, false);
        var currVal_27_2_1 = this.context.education.schoolName;
        ...
        var currVal_42_1_0 = this.context.education.concentration;
        ...
        var currVal_78 = (this._NgModel_27_7.context.valid || this._NgModel_27_7.context.pristine);
        if (import3.checkBinding(throwOnChange, this._expr_78, currVal_78)) {
            this.renderer.setElementProperty(this._el_29, 'hidden', currVal_78);
            this._expr_78 = currVal_78;
        }
        this._NgControlStatus_42_7.checkHost(this, this, this._el_42, throwOnChange);
        var currVal_80 = !this._NgForm_18_3.context.form.valid;
    ...
    View_AddEducationComponent0.prototype.destroyInternal = function () {
        this._NgModel_27_7.ngOnDestroy();
        this._NgModel_42_5.ngOnDestroy();
        this._NgForm_18_3.ngOnDestroy();
    };
    View_AddEducationComponent0.prototype.handleEvent_1 = function (eventName, $event) {
    ...
    View_AddEducationComponent0.prototype.handleEvent_5 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        if ((eventName == 'click')) {
    ...
    View_AddEducationComponent0.prototype.handleEvent_18 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        result = (this._NgForm_18_3.handleEvent(eventName, $event) && result);
        if ((eventName == 'ngSubmit')) {
            var pd_sub_0 = (this.context.saveEducation() !== false);
            result = (pd_sub_0 && result);
        }
        return result;
    };
    View_AddEducationComponent0.prototype.handleEvent_27 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        result = (this._DefaultValueAccessor_27_3.handleEvent(eventName, $event) && result);
        if ((eventName == 'ngModelChange')) {
            var pd_sub_0 = ((this.context.education.schoolName = $event) !== false);
            result = (pd_sub_0 && result);
        }
        return result;
    };
    View_AddEducationComponent0.prototype.handleEvent_42 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        result = (this._DefaultValueAccessor_42_3.handleEvent(eventName, $event) && result);
        if ((eventName == 'ngModelChange')) {
            var pd_sub_0 = ((this.context.education.concentration = $event) !== false);
            result = (pd_sub_0 && result);
        }
        return result;
    };
    View_AddEducationComponent0.prototype.handleEvent_48 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        if ((eventName == 'click')) {
            var pd_sub_0 = (this.context.DeleteEducation() !== false);
            result = (pd_sub_0 && result);
        }
        return result;
    };
    View_AddEducationComponent0.prototype.handleEvent_51 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        if ((eventName == 'click')) {
            var pd_sub_0 = (this.context.onClickedExit() !== false);
    ...
    return View_AddEducationComponent0;
}(import1.AppView));
export { View_AddEducationComponent0 };
