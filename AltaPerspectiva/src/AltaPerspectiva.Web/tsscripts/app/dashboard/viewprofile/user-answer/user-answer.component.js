...
var UserAnswerComponent = (function () {
    function UserAnswerComponent(questionService, _route, profileService) {
    ...
    UserAnswerComponent.prototype.ngOnInit = function () {
        ...
        this.sub = this._route.parent.params.subscribe(function (params) {
            _this.questionService.getAnswerbyUserId(params['userId']).subscribe(function (res) {
                _this.questions = res;
                _this.questions.forEach(function (x) { return x.bestAnswer = x.answers[0]; });
            });
        });
    };
    UserAnswerComponent.prototype.ngOnDestroy = function () {
