...
import * as import0 from '../../../../../tsScripts/app/shared/nav-bar/nav-bar.component';
...
import * as import15 from '../../../../../tsScripts/app/shared/search/apsearch.component';
import * as import16 from '../../../../../tsScripts/app/services/category.service';
import * as import17 from '../../../../../tsScripts/app/services/question-answer.service';
...
export class View_NavBarComponent0 extends import2.AppView<import0.NavBarComponent> {
  ...
  createInternal(rootSelector:string):import9.ComponentRef<any> {
    ...
    this._RouterLinkWithHref_14_3 = new import19.Wrapper_RouterLinkWithHref(this.parentView.injectorGet(import12.Router,this.parentIndex),this.parentView.injectorGet(import26.ActivatedRoute,this.parentIndex),this.parentView.injectorGet(import27.LocationStrategy,this.parentIndex));
    ...
    this._RouterLinkWithHref_24_3 = new import19.Wrapper_RouterLinkWithHref(this.parentView.injectorGet(import12.Router,this.parentIndex),this.parentView.injectorGet(import26.ActivatedRoute,this.parentIndex),this.parentView.injectorGet(import27.LocationStrategy,this.parentIndex));
    ...
    this._RouterLinkWithHref_28_3 = new import19.Wrapper_RouterLinkWithHref(this.parentView.injectorGet(import12.Router,this.parentIndex),this.parentView.injectorGet(import26.ActivatedRoute,this.parentIndex),this.parentView.injectorGet(import27.LocationStrategy,this.parentIndex));
    ...
    this._TemplateRef_32_5 = new import28.TemplateRef_(this,32,this._anchor_32);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import29.RouterLinkWithHref) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 15)))) { return this._RouterLinkWithHref_14_3.context; }
    if (((token === import29.RouterLinkWithHref) && ((24 <= requestNodeIndex) && (requestNodeIndex <= 25)))) { return this._RouterLinkWithHref_24_3.context; }
    if (((token === import29.RouterLinkWithHref) && ((28 <= requestNodeIndex) && (requestNodeIndex <= 29)))) { return this._RouterLinkWithHref_28_3.context; }
    if (((token === import28.TemplateRef) && (32 === requestNodeIndex))) { return this._TemplateRef_32_5; }
    if (((token === import30.NgIf) && (32 === requestNodeIndex))) { return this._NgIf_32_6.context; }
    if (((token === import28.TemplateRef) && (34 === requestNodeIndex))) { return this._TemplateRef_34_5; }
    if (((token === import30.NgIf) && (34 === requestNodeIndex))) { return this._NgIf_34_6.context; }
    if (((token === import31.NgClass) && ((6 <= requestNodeIndex) && (requestNodeIndex <= 48)))) { return this._NgClass_6_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
class View_NavBarComponent2 extends import2.AppView<any> {
  ...
  _text_12:any;
  _el_13:any;
  _NgForm_13_3:import32.Wrapper_NgForm;
  _ControlContainer_13_4:any;
  _NgControlStatusGroup_13_5:import33.Wrapper_NgControlStatusGroup;
  _text_14:any;
  _el_15:any;
  _text_16:any;
  _el_17:any;
  ...
  createInternal(rootSelector:string):import9.ComponentRef<any> {
    ...
    this._NgForm_13_3 = new import32.Wrapper_NgForm((null as any),(null as any));
    this._ControlContainer_13_4 = this._NgForm_13_3.context;
    this._NgControlStatusGroup_13_5 = new import33.Wrapper_NgControlStatusGroup(this._ControlContainer_13_4);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import34.NgForm) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 43)))) { return this._NgForm_13_3.context; }
    if (((token === import35.ControlContainer) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 43)))) { return this._ControlContainer_13_4; }
    if (((token === import36.NgControlStatusGroup) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 43)))) { return this._NgControlStatusGroup_13_5.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (import3.checkBinding(throwOnChange,this._expr_49,currVal_49)) {
      this.renderer.setElementProperty(this._el_4,'src',this.viewUtils.sanitizer.sanitize(import37.SecurityContext.URL,currVal_49));
