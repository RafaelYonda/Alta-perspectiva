...
import * as import0 from 'ng2-img-cropper/src/imageCropperComponent';
...
export class Wrapper_ImageCropperComponent {
  ...
  check_settings(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_0,currValue))) {
      ...
      this._changes['settings'] = new import1.SimpleChange(this._expr_0,currValue);
  ...
  check_image(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_1,currValue))) {
      ...
      this._changes['image'] = new import1.SimpleChange(this._expr_1,currValue);
  ...
  check_cropper(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_2,currValue))) {
      ...
      this._changes['cropper'] = new import1.SimpleChange(this._expr_2,currValue);
      this._expr_2 = currValue;
    }
  }
  check_cropPosition(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_3,currValue))) {
      this._changed = true;
      this.context.cropPosition = currValue;
      this._changes['cropPosition'] = new import1.SimpleChange(this._expr_3,currValue);
  ...
  subscribe(view:import2.AppView<any>,_eventHandler:any,emit0:boolean,emit1:boolean):void {
    ...
    if (emit0) { (this.subscription0 = this.context.cropPositionChange.subscribe(_eventHandler.bind(view,'cropPositionChange'))); }
    if (emit1) { (this.subscription1 = this.context.onCrop.subscribe(_eventHandler.bind(view,'onCrop'))); }
  }
}
...
class View_ImageCropperComponent1 extends import2.AppView<any> {
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import3.createRenderElement(this.renderer,(null as any),'input',new import3.InlineArray4(4,'accept','image/*','type','file'),(null as any));
